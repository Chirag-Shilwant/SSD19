alertify.alert("1. The entire page is divided into 2 parts. The left part consists of the attributes, methods list whereas the right part has a template of class diagram wherein there are multiple classes. <br> <br><br> 2. The goal here is to map appropriate attributes/methods to the correct classes, i.e. drag the items from the left and drop it in right boxes. <br><br><br> 3. You can hover over the classes to get insight of what that particular class is all about.<br><br><br> 4. You can hover over the arrow to know the type of arrow used.").set('resizable',true).resizeTo('50%',425).setHeader('Instructions');
